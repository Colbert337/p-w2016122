package com.sysongy.poms.menu.dao;
...
/**
 * 
 * @FileName     :  BossMenuMapper.java
 * @Encoding     :  UTF-8
 * @Package      :  com.hbkis.boss.menu.dao
 * @Link         :  http://www.hbkis.com
 * @Created on   :  2015年12月15日, 下午6:38:12
 * @Author       :  DongdongHe
 * @Copyright    :  Copyright(c) 2015 西安海贝信息科技有限公司
 * @Description  :
 *
 */
public interface BossMenuMapper {
