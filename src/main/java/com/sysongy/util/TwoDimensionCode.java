...
//    }
     ...
     * @param size 二维码尺寸
     */
    public void encoderQRCode(String content, String imgPath, String imgType,String conterImg, int size) {
        try {  
            BufferedImage bufImg = this.qRCodeCommon(content, imgType, size);
            if(conterImg != null && !"".equals(conterImg)){
                //在二维码中间加入图片
                bufImg = createPhotoAtCenter(bufImg,conterImg);
            }
    ...
    public void encoderQRCode(String content, OutputStream output, String imgType,String conterImg, int size) {
        try {
            BufferedImage bufImg = this.qRCodeCommon(content, imgType, size);
            if(conterImg != null && !"".equals(conterImg)){
                //在二维码中间加入图片
     ...
     * @return
     */
    private BufferedImage createPhotoAtCenter(BufferedImage bufImg,String conterImg) throws Exception {
        if(conterImg == null && "".equals(conterImg)){
            conterImg = "d:/youku.jpg";
        }
        File file = new File(conterImg);
    ...
    public static void main(String[] args) throws IOException {  
        ...
        String centerImg = "d:/youku.jpg";
//        String encoderContent = "http://www.baidu.com";
        String encoderContent = "张三丰";
//        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//        encoderContent = br.readLine();
        TwoDimensionCode handler = new TwoDimensionCode();
        handler.encoderQRCode(encoderContent, imgPath, imgType,centerImg, size);
