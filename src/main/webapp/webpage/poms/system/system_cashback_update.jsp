...
%>
	<script type="text/javascript" src="<%=basePath %>/assets/js/sysparam/system_cashback_update.js"></script>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal"  id="cashbackform">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text"  name="cash_per" placeholder="输入返现系数" class="form-control" maxlength="5" value="${sysCashBack.cash_per}"/>
