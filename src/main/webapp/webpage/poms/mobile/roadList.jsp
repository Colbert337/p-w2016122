	...
	<div class="row">
		<div class="col-xs-12">
					...
					<div class="search-types">
						...
						<div class="item">
							<button class="btn btn-sm btn-primary" type="button" onclick="loadPage('#main','<%=basePath%>/webpage/poms/mobile/roadAdd.jsp');">
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="list" varStatus="s">
										<tr id="${list.id }">
											...
											<td><fmt:formatDate value="${list.captureTime}" type="both" /></td>
											...
											<td><fmt:formatDate value="${list.publisherTime}" type="both" /></td>
											<td>${list.auditor}</td>
