							...
							<div class="col-xs-12">
								...
								<jsp:include page="/common/page_param.jsp"></jsp:include>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="pageTitle" placeholder="输入页面标题" class="form-control" maxlength="30"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="pageTicker" placeholder="输入信息缩略" class="form-control" maxlength="30"/>
										</div>
									</div>
