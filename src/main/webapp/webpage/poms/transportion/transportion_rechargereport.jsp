						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th onclick="orderBy(this,'cash');commitForm();" id="cash_order">交易流水号</th>
									...
									<th onclick="orderBy(this,'fleet_name');commitForm();" id="fleet_name_order">运输公司编号</th>
									...
									<th onclick="orderBy(this,'goods_type');commitForm();" id="goods_type_order">备注</th>>
									<th onclick="orderBy(this,'cash');commitForm();" id="cash_order">操作人</th>
								</tr>
							</thead>
