				...
				<jsp:include page="/common/page_param.jsp"></jsp:include>
					...
					<div class="form-group" id="ratedtime" style="display:none">
						...
						<div class="col-sm-4 datepicker-noicon">
							<input type="text" class="date-picker" name="start_rated_time" id="start_rated_time"  readonly="readonly" data-date-format="yyyy-mm-dd"/>
								<span class="">
									<i class="fa fa-exchange"></i>
								</span>
							<input type="text" class="date-picker" name="end_rated_time" id="end_rated_time"  readonly="readonly" data-date-format="yyyy-mm-dd"/>
						</div>
					</div>
					<div class="form-group" id="money" style="display:none">
						...
						<div class="col-sm-4">
							<input type="text" name="consume_money" placeholder="输入额定消费金额" class="form-control" maxlength="6" required/>
						</div>
					</div>
					<div class="form-group" id="times" style="display:none">
						...
						<div class="col-sm-4">
							<input type="text" name="consume_times" placeholder="输入额定消费次数" class="form-control" maxlength="5" required/>
						</div>
					</div>
