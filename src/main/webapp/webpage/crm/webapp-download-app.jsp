		...
		<div class="section">
			<div class="share">
				...
				<div class="download-app-bd" onclick="statistics(${version})">
					<a class="btn-app-primary logic-download-app" href="http://www.sysongy.net/workspace/apk/sysongy-website-release-1.0.2.apk"><span class="icon-android"></span>下载安卓</a>
				</div>
			</div>
		</div>
		<div class="section">
