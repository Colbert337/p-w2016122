...
<body>
	...
	<div class="bonus-rules-hd" align="center">
		<c:forEach items="${aliPayCashBack}" var="cashBack">
			...
			用户即可获得<span style="font-size:36px; font-weight:lighter; color:#669f31; margin-left:15px; margin-right:15px;"><fmt:formatNumber pattern="0.00" value="${cashBack.cash_per}" type="percent"/></span>的充值
			</div>
		</c:forEach>
	</div>
