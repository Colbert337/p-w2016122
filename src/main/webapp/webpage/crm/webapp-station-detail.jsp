	...
	<div class="pdp">
		...
		<div class="pdp-item">
			<div class="row">
				...
				<div class="col-key">
					<a href="navigation://sysongy.com" class="station-icon"><span style="color: #669F31;" class="icon-direction"></span></a>
					${gastation.address}
				</div>
			</div>
		...
		<div class="pdp-item">
			<div class="row">
				...
				<div class="col-key">
					<a href="tel:${gastation.contact_phone}" class="station-icon"><span style="color: #669F31;" class="icon-phone-1"></span></a>
